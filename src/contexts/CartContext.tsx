      ...
      if (res.ok) {
        ...
        const mappedItems = (data.items || []).map((item: BackendCartItem) => ({
          ...
          product: {
            ...
            images: item.image_url ? [{ url: getFullImageUrl(item.image_url), isPrimary: true }] : [],
        ...
        if (returned) {
          const mapped: CartItem = {
            ...
            product: {
              ...
              images: returned.image_url ? [{ url: getFullImageUrl(returned.image_url), isPrimary: true }] : [],
            } as unknown as Product,
