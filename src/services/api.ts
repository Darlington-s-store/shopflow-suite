...
export const productAPI = {
  getAll: (filters?: Record<string, string | number | boolean>) => {
    ...
    return apiCall(`/products?${params.toString()}`, { method: 'GET' });
  },
...
export const addressAPI = {
  ...
  addAddress: (addressData: Omit<Address, 'id' | 'userId'>) =>
    apiCall('/user/addresses', {
      method: 'POST',
      body: JSON.stringify(addressData),
    }),
  updateAddress: (addressId: number, addressData: Partial<Address>) =>
...
export const reviewAPI = {
  ...
  submitReview: (productId: number, reviewData: Omit<Review, 'id' | 'productId' | 'userId' | 'userName' | 'createdAt' | 'updatedAt' | 'status'>) =>
    apiCall(`/products/${productId}/reviews`, {
      method: 'POST',
      body: JSON.stringify(reviewData),
    }),
  updateReview: (reviewId: number, reviewData: Partial<Review>) =>
...
export const adminAPI = {
  ...
  // Variants
  createVariant: (productId: number, variantData: Partial<ProductVariant>) =>
    apiCall(`/products/${productId}/variants`, {
      method: 'POST',
      body: JSON.stringify(variantData),
    }),
  updateVariant: (variantId: number, variantData: Partial<ProductVariant>) =>
  ...
  updateCategory: (categoryId: number, categoryData: Partial<Category>) =>
